...
export const useSettingsStore = defineStore('settings', () => {
  ...
  const reasonixEnabled = ref(localStorage.getItem('reasonixEnabled') !== 'false')
  ...
  function setReasonixEnabled(val) {
    reasonixEnabled.value = val
    localStorage.setItem('reasonixEnabled', val ? 'true' : 'false')
  }
