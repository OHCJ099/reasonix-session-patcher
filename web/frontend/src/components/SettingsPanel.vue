  ...
  <div class="settings-panel">
    <n-space vertical size="large">
      ...
      <n-card :title="$t('settings.platformSupport')" size="small">
        <n-space vertical>
          <n-form-item :label="$t('settings.reasonixEnabled')">
            <n-switch
              :value="settingsStore.reasonixEnabled"
              @update:value="settingsStore.setReasonixEnabled"
            />
            <template #feedback>
              <span class="form-hint">{{ $t('settings.reasonixEnabledHint') }}</span>
            </template>
          </n-form-item>
