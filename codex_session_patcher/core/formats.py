...
class ReasonixFormatStrategy(FormatStrategy):
    """Reasonix Desktop JSONL 格式。

    当前本机 Reasonix Desktop 会话为一行一个简单消息对象：
    {
        "role": "assistant" | "user" | "system",
        "content": "...",
        "reasoning_content": "..."  # 可选，和助手消息同一行
    }
    """
    ...
    def get_thinking_items(self, lines: List[Dict[str, Any]]) -> List[Tuple[int, Dict[str, Any]]]:
        # Reasonix 的 reasoning_content 嵌入在消息对象里，不是独立行。
        return []
